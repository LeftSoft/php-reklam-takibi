...
$reklamsor=$db->prepare("SELECT * FROM reklam where reklam_durum=0 ORDER BY reklam_id DESC");
$reklamsor->execute();
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Devam Eden Reklamlar</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index">Anasayfa</a></li>
              <li class="breadcrumb-item active">Devam Eden Reklamlar</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
